          ...
          <div className="footer-shop">
            ...
            <ul className="footer-shop-ul">
              <li className="footer-shop-li">
                <Link className="footer-shop-link" to="/apparel">
                  APPAREL
                </Link>
              </li>
              <li className="footer-shop-li">
                <Link className="footer-shop-link" to="/collectibles">
                  COLLECTIBLES
                </Link>
              </li>
              <li className="footer-shop-li">
                <Link className="footer-shop-link" to="/art">
                  ART
                </Link>
              </li>
              <li className="footer-shop-li">
                <Link className="footer-shop-link" to="/accessories">
                  ACCESSORIES
                </Link>
              </li>
            </ul>
          ...
          <div className="footer-support">
            ...
            <ul className="footer-support-ul">
              <li className="footer-support-li">
                <Link className="footer-support-link" to="/orderStatus">
                  ORDER STATUS
                </Link>
              </li>
              <li className="footer-support-li">
                <Link className="footer-support-link" to="/giftCardBalance">
                  GIFT CARD BALANCE
                </Link>
              </li>
              <li className="footer-support-li">
                <Link className="footer-support-link" to="/shippingInformation">
                  SHIPPING INFORMATION
                </Link>
              </li>
              <li className="footer-support-li">
                <Link className="footer-support-link" to="/collectabilityGuide">
                  COLLECTABILITY GUIDE
                </Link>
              </li>
              <li className="footer-support-li">
                <Link className="footer-support-link" to="/accessibility">
                  {" "}
                  ACCESSIBILITY
                </Link>
              </li>
